 ...
 * @author Faisal
 */
public class GetModeState extends HttpServlet {
    ...
    Connection connection = null;  
        ...
        Class.forName("com.mysql.jdbc.Driver").newInstance();  
            ...
            Statement statement = connection.createStatement();  
                    ...
                    .executeQuery("SELECT MODE FROM AC_MAIN WHERE ID='"+AC_LABEL+"'");  
...
//            String mode = airdb.getModeStateSubGrp(node_id.substring(1));
//            out.println(mode);
//            }else if(node_id.startsWith("G")){
//            String mode = airdb.getModeStateGrp(node_id.substring(1));
//            out.println(mode);
//            }
        } finally {            
            out.close();
